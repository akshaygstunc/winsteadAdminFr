...
export function FormActions({ onSubmit, onCancel, submitLabel, busy }: { onSubmit: () => void; onCancel?: () => void; submitLabel: string; busy?: boolean; }) {
  return (
    <div className="flex flex-wrap gap-3">
      <button className="rounded-2xl border border-gold/50 bg-gold/10 px-4 py-2 text-sm font-medium text-gold transition hover:bg-gold/20" onClick={onSubmit} type="button">
