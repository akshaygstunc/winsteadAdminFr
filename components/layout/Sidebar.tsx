...
const menuItems = [
  ...
  { name: "Homepage CMS", icon: FaLayerGroup, path: "/cms/homepage" },
  { name: "Navigation", icon: FaBars, path: "/cms/navigation" },
  { name: "Categories", icon: FaLayerGroup, path: "/categories" },
  { name: "Media Library", icon: FaImage, path: "/media" },
  { name: "SEO", icon: FaSearch, path: "/seo" },
  { name: "Static Pages", icon: FaFileAlt, path: "/cms/static-pages" },
  { name: "Testimonials", icon: FaQuoteRight, path: "/testimonials" },
  { name: "Blog", icon: FaBlog, path: "/blog" },
  { name: "Banners", icon: FaAd, path: "/banners" },
